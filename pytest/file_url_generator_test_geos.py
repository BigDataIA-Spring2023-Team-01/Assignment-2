...
from ..api.file_url_generator import router_file_url_generator
import pytest

client = TestClient(router_file_url_generator)

URL="http://10.0.0.17:8000/filename_url_gen_goes"
...
def test_url_gen6():
 ...
 test_fs_T6 = client.get(URL, params={"filename": test})
